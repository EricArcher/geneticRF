...
#' @param nrep number of replicates for \code{\link[rfPermute]{rfPermute}} permutation 
#'   test. Leave at \code{0} to skip test.
...
#' @export
#' 
sequenceRF <- function(seq.df, replace = FALSE, sampsize = NULL, train.pct = 0.5, min.n = 2, nrep = 0, ...) {
